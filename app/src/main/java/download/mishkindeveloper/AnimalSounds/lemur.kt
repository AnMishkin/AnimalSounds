...
import download.mishkindeveloper.AnimalSounds.databinding.ActivityLemurBinding
...
//следующая картинка
        ...
        binding.imageBack.setOnClickListener {
            var intent = Intent(this,pig::class.java)
    ...
    private fun nextImage(){
        var intent = Intent(this, teddy::class.java)
        startActivity(intent)
    }
    ...
    private fun loadInterAd() {
        ...
        InterstitialAd.load(this,
            "ca-app-pub-3971991853344828/9129142684",
            adRequest,
