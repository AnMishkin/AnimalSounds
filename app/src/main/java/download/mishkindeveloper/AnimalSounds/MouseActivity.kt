...
import download.mishkindeveloper.AnimalSounds.databinding.ActivityMouseBinding
...
//следующая картинка
        ...
        binding.imageBack.setOnClickListener {
            var intent = Intent(this,snake::class.java)
    ...
    private fun nextImage(){
        var intent = Intent(this, elefant::class.java)
        startActivity(intent)
    }
    ...
    private fun loadInterAd() {
        ...
        InterstitialAd.load(this,
            "ca-app-pub-3971991853344828/2372162645",
            adRequest,
